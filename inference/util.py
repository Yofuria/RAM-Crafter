...
def summarize_trial(agents):
    correct = [a for a in agents if a.gpt_correct()]
    incorrect = [a for a in agents if a.is_finished() and ((a.gpt_correct() is False) or (a.gpt_correct() is None))]
...
def summarize_react_trial(agents):
    correct = [a for a in agents if a.if_task_finished()]
    halted = [a for a in agents if a.is_halted()]
    incorrect = [a for a in agents if a.is_finished() and a.if_task_finished() is False]
